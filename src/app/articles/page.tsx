              ...
              <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                <div className="flex items-center mb-6">
                  <div className="w-5 h-5 bg-[#0A66C2] rounded flex items-center justify-center mr-3">
                    <svg className="w-3 h-3 text-white" ="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  {categories.slice(1).map((category, index) => (
                    ...
                    >
                      ...
                      <div className="flex items-center space-x-2">
                        ...
                        <svg className="w-3 h-3 opacity-0 group-hover:opacity-100 transition-opacity" ="none" stroke="currentColor" viewBox="0 0 24 24">
