      ...
      <div className="container mx-auto px-4">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <div className="space-y-4 md:space-y-0 md:space-x-4 md:flex md:justify-center">
            ...
            <Link 
              href="/condos"
              className="inline-block border-2 border-gray-300 text-gray-700 px-8 py-3 rounded-lg font-semibold hover:border-gray-400 hover:text-gray-900 transition-colors"
            >
              Browse Condos
            </Link>
          </div>
          ...
          <div className="mt-12 pt-8 border-t border-gray-200">
            <p className="text-gray-500 mb-4">Looking for something specific? Try these popular pages:</p>
          ...
          <div className="mt-8 p-6 bg-white rounded-xl shadow-sm border">
            ...
            <p className="text-gray-600 mb-4">Get in touch with our team for personalized property advice and information.</p>
            <Link 
              href="/contact"
