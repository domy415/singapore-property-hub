...
export async function POST(request: Request) {
  try {
    ...
    const updatedContent = `# Singapore Property Market Q2 2025: Moderation Signals Sustainable Growth Path

**September 11, 2025 | Last Updated: September 11, 2025 | Article #1,847**

---

> 📊 **Key Takeaway:** Singapore private property prices rose **0.5% QoQ** in Q2 2025, the slowest growth in over a year as transaction volumes fell **40%** to 4,340 units
> 
> 💡 **Why It Matters:** With new launches drying up (only **1,129 units** sold in Q2) and limited supply ahead, the market offers negotiation opportunities for serious buyers
> 
> 🎯 **Action Required:** Focus on resale market and remaining units from recent launches as Q4 2025 pipeline remains limited
...
> 💰 **Market Insight:** OCR offers best risk-reward with limited upcoming supply and consistent demand
...
> 🎯 **Buyer Strategy:** With limited new supply, focus on unsold units from recent launches for immediate availability
...
| **TDSR threshold** | **60%** of gross income | Borrowing capacity limited |
...
✅ **Focus on**: Remaining OCR units from 2025 launches
...
✅ **Target**: RCR units with price corrections
...
✅ **Strategy**: Consider upgrading while HDB prices remain strong
...
- ✅ Calculate maximum loan under **60% TDSR**
- ✅ Get AIP from 3 banks for comparison
- ✅ Review unsold inventory from recent launches

**Week 2: Market Survey**
- ✅ View 5-8 properties in target districts
- ✅ Compare resale vs new launch options
- ✅ Assess negotiation potential

**Week 3: Decision Making**
- ✅ Shortlist top 3 options
- ✅ Conduct detailed financial planning
- ✅ Engage lawyer for legal advice

**Week 4: Execution**
- ✅ Submit offer with negotiation
- ✅ Lock in mortgage rate
- ✅ Complete option exercise
...
**Article #1,847** | Published: September 11, 2025 | Category: Market Analysis`
    ...
    const updatedArticle = await prisma.article.update({
      ...
      data: {
        ...
        excerpt: "Singapore private property prices rose 0.5% QoQ in Q2 2025, the slowest growth in over a year as transaction volumes fell 40% to 4,340 units. With new launches drying up and limited supply ahead, the market offers negotiation opportunities for serious buyers.",
        seoTitle: "Singapore Property Market Q2 2025: 0.5% Growth Signals Market Moderation",
        seoDescription: "Q2 2025 Singapore property analysis: Private prices +0.5% QoQ, transactions down 40%, only 1,129 new units sold. CCR leads growth at 2.3% while RCR declines 1.1%. Complete market data and buyer strategies inside.",
        seoKeywords: ["singapore property q2 2025", "property market analysis", "ura flash estimates", "singapore real estate", "property price growth", "new launch sales", "resale transactions", "cooling measures", "sora rates", "property investment singapore"],
        updatedAt: new Date()
      }
    })
    ...
    return NextResponse.json({
      success: true,
      message: 'Article content replaced successfully',
      article: {
    ...
    console.error('Error replacing article content:', error)
    return NextResponse.json(
      { error: 'Failed to replace article content', details: error.message },
      { status: 500 }
    )
  }
}